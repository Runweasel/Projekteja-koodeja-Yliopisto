...
const int ACCOUNT_NONE = 0;
const std::string CODE_NONE = "";
...
public:
    ...
    /**
     * @brief is_code_or_account_valid
     * @param course code, account number
     * Checks if the given account and/or code is valid.
     * This is found by if the given parameter is part of the
     * courses_ map or accounts_ map.
     * If no account or code is found, gives an error.
     */
    bool is_code_or_account_valid(std::string code, int account);
